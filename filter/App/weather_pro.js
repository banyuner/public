 ...
 */
let config = {
    darksky_api: "4e8822d3d1d8bc3bdd8a56ab520f87ad", //从https://darksky.net/dev/ 上申请key填入即可
    aqicn_api: "958d9c4d98d4606c749c28e8e9b8db02d9c4b42a", //从http://aqicn.org/data-platform/token/#/ 上申请key填入即可
    huweather_apiKey: "70a46bd6df3342289efd5d17331f8b8d", //和风天气APIkey,可自行前往 https://dev.heweather.com/ 进行获取
    lat_lon: "30.515801, 114.299899", //请填写经纬度,直接从谷歌地图中获取即可
    ...
    show: {
        //普通每天的
        template: {
            title: `$[province]$[city]市$[district]区 $[weatherIcon]$[weather] $[summary]`,
            subtitle: `$[temperatureMin] ~ $[temperatureMax]°C ☔️降雨概率 $[precipProbability]%`,
...
$[province]$[city]市$[district]区 $[weeklySummary]
